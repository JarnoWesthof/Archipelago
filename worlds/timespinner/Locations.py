...
def get_location_datas(world: Optional[MultiWorld], player: Optional[int], 
    ...
    location_table: List[LocationData] = [
        ...
        LocationData('Military Fortress', 'Military Fortress: Bomber chest',  1337058, lambda state: state.has('Timespinner Wheel', player) and logic.has_doublejump(state)),
        ...
        LocationData('Military Fortress (hangar)', 'Military Fortress: Giantess room',  1337061, logic.has_timestop),
        LocationData('Military Fortress (hangar)', 'Military Fortress: Giantess bridge',  1337062),
        LocationData('Before the lab', 'Military Fortress: B door chest 2',  1337063, logic.has_keycard_B),
        LocationData('Before the lab', 'Military Fortress: B door chest 1',  1337064, logic.has_keycard_B),
        LocationData('Military Fortress (hangar)', 'Military Fortress: Pedestal',  1337065, flooded.flood_lab or logic.has_doublejump_of_npc or logic.has_forwarddash_doublejump or logic.has_fastjump_on_npc),
        LocationData('The lab', 'Lab: Coffee break',  1337066),
        LocationData('The lab', 'Lab: Lower trash right',  1337067, flooded.flood_lab or logic.has_doublejump or logic.has_fastjump_on_npc),
        LocationData('The lab', 'Lab: Lower trash left',  1337068, flooded.flood_lab or logic.has_upwarddash),
        LocationData('The lab', 'Lab: Below lab entrance',  1337069, flooded.flood_lab or logic.has_doublejump),
        LocationData('The lab (power off)', 'Lab: Trash jump room',  1337070, logic.has_upwarddash),
